    ...
    return (
        ...
        <VolumeCalculateModal handleAdd={handleAdd} modalopen={modalopen} totalVolume={totalVolume} setTotalVolume={setTotalVolume} handleclose={handleClose}/>
            <div className='flex w-[70%] '>
                ...
                <div className='flex flex-col mt-10 w-[100%]'>
                <div className="flex flex-col w-[35%] ml-[20px] mt-[5px]">
              ...
              <TbRulerMeasure onClick={()=>handleOpen()} className="absolute text-[30px] cursor-pointer right-0 top-5" />
                ...
                <div className='flex flex-col '>
                    ...
                    <input type="text" placeholder='Operator' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...mydata, operater: e.target.value }) }} value={mydata?.operater} />
                </div>
                <div className='flex flex-col '>
                <h2 className='text-[17px]'>Reference</h2>
                <input type="text" placeholder='Reference' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...mydata, referance: e.target.value }) }} value={mydata?.referance} />
            </div>
            <div className='flex flex-col '>
            <h2 className='text-[17px]'>Attendant</h2>
            <input type="text" placeholder='Attendant' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...mydata, attendant: e.target.value }) }} value={mydata?.attendant} />
        </div>
        <div className='flex flex-col '>
        <h2 className='text-[17px]'>Attendant Phone</h2>
        <input type="text" placeholder='Attendant Phone' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...mydata, attendantPhone: e.target.value }) }} value={mydata?.attendantPhone} />
    </div>
            </div>
            </div>
            </div>
