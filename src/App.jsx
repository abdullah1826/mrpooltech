    ...
    <div className='w-[100%]'>
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/Invoice2/:id/:type' element={<RequireAuth><Invoice2 /></RequireAuth>} />
          <Route path='/Invoice3' element={<RequireAuth><Invoice2 /></RequireAuth>} />

                <Route exact path="/invoiceSummary" element={<InvoiceSummary />} />
