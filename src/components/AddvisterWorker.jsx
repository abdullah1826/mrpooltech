        ...
        if (data.workerName && data.email && data.password) {
            await createUserWithEmailAndPassword(auth, data.email, data.password)
                .then((userCredential) => {
                    ...
                    update(ref(db, `visitingWorkers/${user.uid}`), { ...data, id: user.uid })
                        ...
                        uploadString(storageRef, img.slice(23), "base64", {
                          ...
                          .then(() => {
                            ...
                            getDownloadURL(storageRef)
                              .then((URL) => {
                                // console.log(URL)
                                update(ref(db, `visitingWorkers/${user.uid}`), { profileUrl: URL });
                                setimg("");
                        ...
                        <div className='flex  '>
                            ...
                            <div className='flex justify-between flex-wrap ml-[50px] h-[400px] mt-[50px] flex-col'>
                                ...
                                <div className='flex flex-col mt-[25px]'>
                                    ...
                                    <input type="number" placeholder='Phone' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...data, phone: e.target.value }) }} value={data.phone} />
                                </div>
                                <div className='flex flex-col mt-[25px]'>
                                ...
                                <div className='flex flex-col mt-[25px]'>
                                <h2 className='text-[17px]'>job type</h2>
                                <input type="text" placeholder='Job type' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...data, jobType: e.target.value }) }} value={data.jobType} />
                            </div>
                            </div>
                            ...
                            <div className='flex justify-between flex-wrap ml-[50px] h-[320px] mt-[50px]  flex-col'>
                                ...
                                <div className='flex flex-col mt-[25px]'>
                                    ...
                                    <input type="number" placeholder='Salary' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...data, sallary: e.target.value }) }} value={data.sallary} style={{ MozAppearance: "textfield", WebkitAppearance: "none", appearance: "none" }} />
                                </div>


                                <div className='flex flex-col mt-[25px]'>
                                    <h2 className='text-[17px]'>Password</h2>
                                    <input type="text" placeholder='Password must be at least 6 characters' className='h-[28px] w-[310px] text-[13px] border-b-[1px] border-[#464141]  p-1 outline-none placeholder:text-sm' onChange={(e) => { setData({ ...data, password: e.target.value }) }} value={data.password} />
                                </div>
