...
const PermentWorker = () => {
    ...
    const columns = [
        ...
        { name: 'Email', selector: (row) => { return row.email }, sortable: true,width:"120px" },
        { name: 'Password', selector: (row) => { return row.password }, sortable: true, width:"120px"},
        { name: 'Phone', selector: (row) => { return row.phone }, sortable: true,width:"120px" },
