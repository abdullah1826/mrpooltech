...
${
  selectedCheckboxes[label]
    ...
    : "bg-white border-gray-300"
              ...
              {/* select check boxes */}
              {/* <div className="p-6 bg-white shadow-lg rounded-lg w-[90%] mt-5">
